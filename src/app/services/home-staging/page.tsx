        ...
        <PageLayout page="home-staging">
            ...
            <div className="flex flex-col items-center w-full h-fit py-16 px-8 space-y-8 bg-stone-900">
                ...
                <div className="flex flex-col space-y-6 max-w-4xl text-stone-300">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-secondary_light">
                        ...
                        <li className='text-stone-300'>
                            <strong className='text-secondary_light'>Implementation:</strong> We stage your home using high-quality furnishings and decor.
                        </li>
                        <li className='text-stone-300'>
