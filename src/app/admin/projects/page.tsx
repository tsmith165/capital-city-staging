...
export const metadata: Metadata = {
    title: 'Capital City Staging - Manage Projects',
    description: 'Manage staging projects for Capital City Staging.',
    keywords: 'Capital City Staging, Sacramento Staging, Project Management, Home Staging Projects',
...
export default function AdminProjectsPage() {
    return (
        <PageLayout page="/admin/projects">
            <AdminProjectsClient />
        </PageLayout>
    );
}