...
const locationData = {
    ...
    imageUrl: '/locations/west-sacramento.jpg',
...
export const metadata: Metadata = generateLocationMetadata({
    ...
    description: 'Expert home staging services in West Sacramento, California. Make your property irresistible with Capital City Staging.',
