    ...
    return (
        <PageLayout page="benefits-of-home-staging">
            ...
            >
                ...
                <p>
                    You work with Mia Dofflemyer directly. She is a RESA-certified stager and a licensed California real estate agent, so
                    the plan for your home is built on what is actually selling in your market, not on a generic look.
                </p>
            </ArticleShell>
        </PageLayout>
    );
