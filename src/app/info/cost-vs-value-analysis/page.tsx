    ...
    <PageLayout page="cost-vs-value-analysis">
      ...
      <div className="flex flex-col items-center w-full h-fit py-16 px-8 space-y-8 bg-stone-900">
        ...
        <div className="flex flex-col space-y-6 max-w-4xl text-stone-300">
          ...
          <p className="text-stone-300">
            <strong className='text-secondary_light'>Without Staging:</strong> Home listed at $500,000. After several months on the
            market, the price is reduced to $480,000 to attract buyers.
          </p>
          <p className="text-stone-300">
            <strong className='text-secondary_light'>With Staging:</strong> Initial staging cost is $3,000. The home sells within a
