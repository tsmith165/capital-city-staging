...
export const CTA_CLASSES =
    'inline-flex items-center justify-center rounded-md bg-gold-400 px-4 py-2 text-[13px] font-bold uppercase tracking-[0.06em] text-body-inverse transition-colors hover:bg-gold-300 whitespace-nowrap';
